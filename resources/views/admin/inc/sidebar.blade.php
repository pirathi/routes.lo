            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="/setting">Application</a>
                ...
                <div class="collapse {{ isActiveRoute('post.index') ? 'show' : (isActiveRoute('post.create') ? 'show' : (isActiveRoute('post.edit') ? 'show' : ''))}}" id="collapsePosts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                ...
                <div class="collapse {{ isActiveRoute('category.index') ? 'show' : (isActiveRoute('category.create') ? 'show' : (isActiveRoute('category.edit') ? 'show' : ''))}}" id="collapseCategory" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
